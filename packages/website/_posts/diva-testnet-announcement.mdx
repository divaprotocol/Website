...
place on the Goerli testnet using fake ERC20 tokens and fake ETH.**
...
- Hit Enter to confirm. In addition to the address registration, you will receive test ERC20 tokens called [dUSD](https://goerli.etherscan.io/address/0xFA158C9B780A4213f3201Ae74Cca013712c8538d) that you will need to start
  testing the app.
...
[^1]:
    It is important to highlight that placing a BUY/SELL LIMIT order is not enough to complete this task. The order has to be filled by
...
[^2]:
    Note that the manual reporting process of the final value and the possibility to challenge are only relevant for cases where human
...
The testnet is conducted on the **Goerli network** and you have time to complete all tasks until **30 September 2022**.
