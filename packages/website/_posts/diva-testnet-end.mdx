...
The most important topic for testnet participants is the DIVA token reward that they have been promised for completing the testnet tasks. Before we mention the reward,
...
The methodology suggests that the threshold for receiving a 1:1 conversion between testnet points and DIVA tokens would have been 222 participants assuming 4500 points for full completion of the tasks.
As the reward pool was capped at 1 million DIVA tokens as a measure to disincentivize Sybil attacks, any additional participation resulted in a dilution of the rewards.
With 2'222 participants, for instance, the reward would have gone down to 450 DIVA tokens, c. $45 assuming a $10m project valuation. That was at the lower end of what we were planning
to hand out to testnet participants for their time and effort. With 800 discord members before the testnet launch and without any major marketing plans, we deemed more than 2'000 participants
a highly ambitious target.

We were proven wrong, to our positive surprise and to the detriment of the testnet participants. Multiple how-to videos on how to complete the tasks published by community members as well as
Twitter individuals tweeting about the DIVA testnet has attracted a lot of attention resulting in much more participation than we have anticipated.

The implication is that the high participation has diluted each participant's reward down to 100 DIVA tokens which is equivalent to $10 assuming a 10m token valuation.
**Don't be disappointed, read on how we want to distribute more rewards.**

A few comments:

- The reward pool cap of 1 million DIVA tokens was introduced as one of the measures to disincentivize Sybil attacks.
- The cap of 1 million DIVA tokens was introduced as a measure against Sybil attacks
- Some users have
...
* Mention allocation for whales

### DIVA exam

### Second phase of incentivized test
...
- **Trade chart:** In preparation for the re-design of the trading page, we have upgraded the payoff chart design, moved it more prominently into the middle of
  ...
  The following screenshot gives you preview of the new trade page design that we
  are working towards.
  <p align="center">
