...
On 30th September, the first phase of DIVA's [incentivized testnet](#https://www.divaprotocol.io/posts/diva-testnet-announcement) ended. The goal of the testnet was to invite users to explore the
...
As the reward announcement got delayed due to the [additional verification step](#https://www.divaprotocol.io/posts/diva-verification-announcement)
requested by our community to address the problem of multi-accounts, we don't want you to wait any longer. Here the rewards:
...
You can check your reward [here](#https://www.divaprotocol.io/): 

Overall, a total of 1.12m DIVA tokens has been allocated to more than 13'600 users, 12% more than originally planned due to rounding up the rewards.

For those that are interested in the details about the verification, read on.

## Verification process
To exclude users that participated with multiple accounts to increase their allocation at the expense of honest single account users, we have conducted a 
verification process. We decided to go with the Double Counter Discord bot as it was the most efficient solution and it didn't require users to share 
personal information as is the case during KYC.
...
* 18th October: opened a verification-issues channel where users were able to report technical that they have encountered during the verification process.  


The following registered users are eligible:
* Users that verified on first attempt
* User that were blocked on first attempt because of using a VPN but got verified on second attempt
* Holders of an 888Whales NFT (5)
* Quiz winners (85)
* Users that had technical issues or missed the verification process and reported it in the verification-issues channel or (c. 300)
