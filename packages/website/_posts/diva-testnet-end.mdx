...
After adjusting for multi-accounts, testnet participants have collected a total of 80m points which implies the following rewards for testnet users:

- 2.5 DIVA tokens per completed task
- **57 DIVA** tokens for full completion
- **114 DIVA tokens** for full completion and ownership of an 888Whale NFT

To put things in perspective, 57 DIVA tokens is 40% larger than the Uniswap airdrop on a valuation adjusted basis (the 400 UNI token airdrop is worth 
c. $2.5k at the current $6.3bn fully diluted market cap). 
