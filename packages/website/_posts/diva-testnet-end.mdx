...
After 2.5 months, the first phase of DIVA's incentivized testnet ended on 30th September. The goal of the testnet was to invite users to explore the
...
- Total contingent pools created: **170.0k**
- Unique addresses participated: **26.1k**
- Number accounts that completed all tasks: **13.8k**
...
The reward announcement got delayed as we introduced an [additional verification step](#https://www.divaprotocol.io/posts/diva-verification-announcement)
to address the community's concern that some users may have used multiple accounts to increase their reward and dilute the reward of those using a single account.
...
* 14th October: the verification process started
* 17th October: the verificatoin process ended
* 18th October: we opened a verification-issues channel where users that encountered technical issues during the verification process could report their case.  
...
If an account has been suspected to be a multi-account, none of the related accounts is eligible. 
...
After excluding multi-accounts, testnet participants have collected a total of 80m points which results in the following rewards for testnet users:
