...
After 2.5 months, the first phase of DIVA's incentivized testnet has ended. The goal of the testnet was to invite users to explore the
...
## Verification
To address the concern of the community that some users may have used multiple accounts to increase their reward and dilute the reward of single account users, 
we have conducted an [additional verification step](#https://www.divaprotocol.io/posts/diva-verification-announcement).
...
- 4.4 DIVA tokens per completed task
- **100 DIVA** tokens for full completion
- **200 DIVA tokens** for full completion and ownership of an 888Whale NFT
