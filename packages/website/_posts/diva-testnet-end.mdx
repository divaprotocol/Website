...
to filter out multi-accounts. That's why we don't want you to wait any longer. Here the testnet rewards:
...
You can check your reward [here](https://www.divaprotocol.io/). Overall, a total of 1.12m DIVA tokens have been allocated to more than 13'600 users. That is
...
There will be a maximum of 100m tokens with the majority being distributed over time to those that use and build on top of DIVA Protocol. Read more about the DIVA tokenomics 
