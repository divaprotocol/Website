...
to filter out multi-accounts. That's why we go with the final testnet rewards first and provide more details on the verification process as well as what comes next in the following sections.
...
* The completion of all [testnet tasks](https://app.diva.finance/tasks) will be mandatory to be eligible for all future reward rounds including the second testnet phase.
