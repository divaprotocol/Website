...
Roughly 1'000 alt accounts and their corresponding main accounts (3.7m in terms of points, 4.7% of total points collected) have been blocked and excluded from the reward distribution. 

The vast majority (c. 25m points), however, didn't participate in the verification process at all, either because they missed it or because they didn't try to verify their alt accounts due to the 
thread of losing all rewards if identified as a multi-account. Those that reported technical issues during the verification process or missed the verification but reached out to us with a reason 
were verified manually. [888Whales NFT](https://opensea.io/collection/888whales) as well as quiz winners were automatically verified.
