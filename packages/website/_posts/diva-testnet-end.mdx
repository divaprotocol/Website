...
to address the problem of multi-accounts. That's why we don't want you to wait any longer. Here the testnet rewards:
...
Tokens can be claimed once the token is launched which is expected to coincide with the mainnet launch of the DIVA protocol in Q1 2023.
