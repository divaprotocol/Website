...
The token unlock schedule is illustrated below. Note that the figures are still indicative due to on-going fundraising and upcoming second testnet phase. 
Final numbers will be confirmed and published closer towards mainnet launch.
