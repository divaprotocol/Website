...
To understand the purpose of a smart contract audit, it is important to first understand what a smart contract is. A smart contract is a software that runs on a 
...
The DIVA Protocol launch partner program serves two goals: i) it gives institutions and individuals an opportunity to publicly signal their support for decentralized 
finance technologies and ii) it helps build a diverse and decentralized community of token holders, which is essential for the success of any 
...
to publicly signal their support for the development of decentralized finance technologies in exchange for DIVA governance rights. Join us on our journey to transform the derivatives industry.
