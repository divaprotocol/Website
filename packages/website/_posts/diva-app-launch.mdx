...
1. [DIVA Protocol](https://www.divaprotocol.io/) - for the creation and settlement of derivative markets
2. [0x Protocol](https://0x.org/) - for trading the corresponding derivative assets
...
Head over to the [Create](https://app.diva.finance/Create) to discover the flexibility.
...
Whether you're an individual seeking to create and trade derivative contracts or a crypto platform looking to expand your client offerings, the DIVA App empowers 
you to embrace the potential of decentralized finance. 

The DIVA App represents just one example of the diverse range of applications that can be built on top of DIVA Protocol. Join us on this exciting 
journey and help us to unlock a world of innovative financial applications.
