...
export const faqData = [
    ...
    body: (
      <>
        <Text fontSize={["18px", "18px", "20px", "20px", "20px"]}>
          ...
          derivatives. It acts as an operating system for all kinds of
          derivative applications including insurance, prediction markets,
          structured products as well as event-driven conditional donations.
          Users can choose any public data feed as the underlying (e.g., the
          price of an asset or a basket of assets, the TVL locked in DeFi,
          Ethereum gas price, Bitcoin hash rate, the average temperature, etc.)
          and combine it with a wide range of possible payoff profiles (binary,
          linear, convex, or concave) to create truly unique products that do
          not yet exist in DeFi and the traditional financial world.
        </Text>
      </>
    ),
  },
  {
    ...
    body: (
      <Text fontSize={["18px", "18px", "20px", "20px", "20px"]}>
        Head over to the [dApps](https://www.divaprotocol.io/) page to find all
        the applications that have been built on top of DIVA Protocol. They
        allow you to create bets, insurances, structured products and
